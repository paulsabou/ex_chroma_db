defmodule ExChromaDb do
  ...
  @spec create_database(Types.database_info()) ::
  ...
  @spec get_database(Types.database_info()) ::
  ...
  @spec get_or_create_database(Types.database_info()) ::
          Types.one_result(boolean())
  ...
  @spec list_databases(String.t(), Types.pagination()) ::
  ...
  @spec count_collections(Types.database_info()) :: Types.one_result(non_neg_integer())
  ...
  @spec create_collection(Types.collection_info()) ::
          Types.one_result(String.t())
  ...
  @spec get_or_create_collection(Types.collection_info()) ::
          Types.one_result(boolean())
  ...
  @spec get_collection_info(Types.collection_info()) ::
  ...
  @spec list_collections(Types.database_info(), Types.pagination()) ::
          Types.list_result(Vec.t())
  ...
  @spec delete_collection(Types.collection_info()) :: Types.one_result(boolean())
  ...
  @spec collection_records_count(Types.collection_info()) :: Types.one_result(non_neg_integer())
  ...
  @spec collection_records_delete(Types.collection_info(), %{
          ids: list(Types.record_id()) | nil,
          where: map() | nil,
  ...
  @spec collection_records_query(
          ...
          %{
            ...
            where: map() | nil,
            where_document: map() | nil,
            query_embeddings: list(Types.document_embedding()) | nil,
  ...
  @spec collection_records_delete_by_ids(Types.collection_info(), list(Types.record_id())) ::
          Types.one_result(boolean())
  ...
  @spec collection_records_delete_by_metas(Types.collection_info(), map()) ::
          Types.one_result(boolean())
